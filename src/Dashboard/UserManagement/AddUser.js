...
export default function AddUser() {
  ...
  const editdata=()=>{
    if(item && accessvalue===true)
    {
        Navigate('/user-management');
    }
    else if(item && accessvalue===false)
    {
        alert("please edit the value ");
    }
    else
    {
        Navigate("/user-management");
            ...
            <div className="row">
                ...
                <div className="col-md-10">
                    ...
                    <div className="row light-gray">
                        ...
                        <div className="col-md-6 ">
                        <p className='btn btn-primary mb-3 btn-back' onClick={editdata}>Back To List</p>  
                        </div>
